...
export function ResetControl({ onReset, className = '' }: ResetControlProps) {
  return (
    <button
      className={[
        'inline-flex min-h-14 shrink-0 items-center justify-center rounded border border-slate-300 bg-slate-950 px-5 text-sm font-semibold uppercase tracking-normal text-white shadow-sm sm:min-w-32',
